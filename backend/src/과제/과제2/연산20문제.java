...
public class 연산20문제 {
	...
	public static void main(String[] args) {
		...
		double result13 = (height3 - 100) * 0.9;
		...
		double bmi = kg / ((height2 / 100.0) * (height2 / 100.0));
		...
		double result11 = (midle * 0.3) + (fin * 0.3) + (extra * 0.4);
		
		System.out.printf("%.2f점",result11);
		...
		result = age >=10 && age < 20 ? "학생입니다." : age >= 20 && age <40 ?
			"성인입니다." : "중년입니다.";
		...
		result = id.equals("admin") && pw.equals("1234") ? "로그인 성공" : "로그인 실패";
